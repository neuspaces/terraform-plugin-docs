...
func Generate(ui cli.Ui, legacySidebar bool, tfVersion string, providerName, renderedProviderName, renderedWebsiteDir, examplesDir, websiteTmpDir, websiteSourceDir string) error {
	g := &generator{
